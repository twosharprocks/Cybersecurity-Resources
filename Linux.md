...
* -t: test files to be gunzipped (silent if no issue)
    * tar -tzf my_tar.tar.gz >/dev/null tests & throws away output _without_ unzipping
...
## User, Group & System Management {#user-group-&-system-management}
...
### Important folders in /etc {#important-folders-in-etc}
...
[Chgrp](https://linuxize.com/post/chgrp-command-in-linux/) command, [Shared directories](https://www.tutorialspoint.com/how-to-create-a-shared-directory-for-all-users-in-linux#)
